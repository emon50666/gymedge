...
const NewsLetter = () => {
    ...
    const handelNessLetter = async (event) =>{
        ...
        await axiosPublic.post('/news',userInfo)
            ...
            <div className='md:flex justify-center '>
                <div className='flex-1 bg-orange-500  px-5 pt-10 md:pt-32 '>
                 ...
                 <form onSubmit={handelNessLetter}>
                    <input type="text" name='name' placeholder="Name" className="input border-none input-bordered input-warning w-full max-w-xs" />
                    <input type="email" name='email' placeholder="Email" className="input border-none mt-2 mb-2 input-bordered input-warning w-full max-w-xs" />
                    <button className="btn btn-outline relative  lg:right-[99px]   font-bold text-base
                     border-none bg-black text-white">Subscribe</button>
