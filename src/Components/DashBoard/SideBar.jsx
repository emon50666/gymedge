...
import {  FaBlogger, FaHome, FaMoneyBill } from "react-icons/fa";
...
const SideBar = () => {
    ...
    return (
      ...
      >
       ...
       <Link to={'profile'}> <button onClick={()=>logOut()} className="flex font-bold text-orange-500 items-center mb-5 mt-5 gap-2"> <MdLogout></MdLogout> Profile</button></Link>
